...
namespace OnlineCoin.Controllers
{
    public class CoinsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Symbol,LastPrice,DailyChange,High,Low,Volume,Exchange")] Coin coin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Symbol,LastPrice,DailyChange,High,Low,Volume,Exchange")] Coin coin)
        {
            if (ModelState.IsValid)
            {
